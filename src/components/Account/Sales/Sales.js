    ...
    <div>
      <div className={styles.encabezado}>
        <div className={styles.filtro}>
          <Select placeholder="Filtrar por: Todo" options={[{key:'todo', value:0,text:"Todo"},{key:'estaSemana', value:1,text:"Últimos 7 días"},{key:'esteMes', value:2,text:"Este Mes"},{key:'mesPasado', value:3,text:"Mes Pasado"},{key:'esteAnio', value:4,text:"Este Año"},{key:'anioPasaado', value:5,text:"Año Pasado"}]} onChange={(_,data)=>onSearchMes(data.value)}/>      
        </div>
